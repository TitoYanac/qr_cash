...
class UserOtpSenderForgotPassForm extends StatefulWidget {
  const UserOtpSenderForgotPassForm({super.key});

  @override
  State<UserOtpSenderForgotPassForm> createState() => _UserOtpSenderForgotPassFormState();
}

class _UserOtpSenderForgotPassFormState extends State<UserOtpSenderForgotPassForm> {
          ...
          builder: (context, state) {
            return MyButtonSubmit(
              onButtonPressed: () async {
                AuthenticationService(context).requestOtpPassForgotService(_phoneNumberController.text,_isCheckBoxChecked);
              },
