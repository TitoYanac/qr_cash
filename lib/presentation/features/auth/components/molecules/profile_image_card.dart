...
import 'package:qrcash/presentation/features/user/components/organism/my_avatar.dart';
...
class _ProfileImageCardState extends State<ProfileImageCard> {
  ...
  Widget _buildImageContainer() {
    return const MyAvatar(size: 180, imageUrl: '',);
  }
  ...
  Widget _buildUploadButton() {
    if (_uploading) {
      ...
      return _image == null ? const Icon(Icons.camera_alt) : const Icon(Icons.save);
    }
  }
    ...
    if (_image != null) {
      ...
      await _image!.readAsBytes().then((imageBytes) {
        ...
        UserService(context).updateUserImage(
          ...
          Widget test= CachedNetworkImage(
